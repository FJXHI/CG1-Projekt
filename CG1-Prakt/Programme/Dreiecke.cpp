...
{printf("\n%s",(char*)glGetString(GL_RENDERER));
 ...
 GLfloat vertices[NumVertices][2]={
  {-0.90,-0.90},{0.85,-0.90},{-0.90,0.85},{0.90,-0.85},{0.90,0.90},{-0.85,0.90}}; // Setzt Punkte für Randlinien.
...
{glClear(GL_COLOR_BUFFER_BIT);
  glBindVertexArray(VAOs[Triangles]);
  glVertexAttrib3f(vColor,1,0,0); //Farbe 100 Rot, 101 Pink, 001 Blau, 111 Weiß, 110 Gelb, 010 Grün
  glDrawArrays(GL_TRIANGLES,0,NumVertices/2); // 0 LU.LO.RCU, 1 LO.RCU.RU, 2 LO.RU.RO, 3 LCO.RU.RO, 4 LCO.RO.Mitte, 5 LCO.Mitte Strich, 6 OFF
